MasonEnsureInstalled = vim.list_extend(MasonEnsureInstalled, { 'roslyn-language-server' })
TreesitterEnsureInstalled = vim.list_extend(TreesitterEnsureInstalled, { 'c_sharp' })
